  ...
  IN EFI_SYSTEM_TABLE *SystemTable)
{
  ...
  Status = gBS->InstallMultipleProtocolInterfaces(&ImageHandle, &gMediatekKeypadDeviceProtocolGuid, &mInternalKeypadDevice, &gEfiDevicePathProtocolGuid, &KeypadDevicePath, NULL);
  if (EFI_ERROR (Status)) {
