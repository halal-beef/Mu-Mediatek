...
//--------------------- DDR ---------------------
    ...
    {"UEFI Stack",        0x42030000, 0x00040000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
    {"CPU Vectors",       0x42080000, 0x00010000, AddMem, SYS_MEM, SYS_MEM_CAP, BsCode, WRITE_BACK},
    {"DXE Heap",          0x42090000, 0x05c00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
