# @file
# Script to Build Lenovo 2.2 UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("achilles6Pkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('achilles6', 'gcc_aarch64_linux', 'edk2-build')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("achilles6Pkg/achilles6.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "achilles6Pkg/achilles6.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "achilles6", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "achilles6Pkg/achilles6.dsc", "Platform Hardcoded")
