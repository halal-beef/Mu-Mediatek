# @file
# Script to Build Galaxy Tab A7 Lite UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("gta7litePkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('gta7lite', 'gcc_aarch64_linux', 'edk2-build')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("gta7litePkg/gta7lite.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "gta7litePkg/gta7lite.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "gta7lite", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "gta7litePkg/gta7lite.dsc", "Platform Hardcoded")
