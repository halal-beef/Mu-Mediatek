...
!endif
  ...
  # SmBios
  gSamsungPkgTokenSpaceGuid.PcdSmbiosSystemVendor|"HMD Global Oy"
  gSamsungPkgTokenSpaceGuid.PcdSmbiosSystemModel|"Nokia 2.2"
  gSamsungPkgTokenSpaceGuid.PcdSmbiosSystemRetailModel|"TA-1188"
