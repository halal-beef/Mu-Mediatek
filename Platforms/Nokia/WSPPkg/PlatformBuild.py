# @file
# Script to Build Nokia 2.2 UEFI firmware
#
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "WSPPkg/WSP.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "WSP", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "WSPPkg/WSP.dsc", "Platform Hardcoded")
